...
#         # no of examples at each step/batch
        ...
        self.train_loader, self.val_loader, self.test_loader, self.n_train, self.n_val, self.n_test, data_kwargs = get_data(args.dataset, batch_size, arch, args.valid_split)
