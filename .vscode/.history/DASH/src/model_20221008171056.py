    ...
    def train(self, dataset, val_dataset=None, val_metadata=None, remaining_time_budget=None):
        ...
        ****************************************************************************
        ...
        for ep in range(epochs):
            train_loss = train_one_epoch(self.model, self.optimizer, self.scheduler, self.args.device, self.train_loader, loss, clip, 1, n_train_temp, decoder, transform, lr_sched_iter, scale_grad=not args.baseline)
